...
<div class="post df">
  <div class="info df">
    ...
    <h4 class="info__title">{post.title}</h4>
    <p class="info__content">{post.content}</p>
  </div>
  <div class="stats df">
    ...
    <p class="stats__date">{formatTimeAgo(new Date(post.created_at))}</p>
  </div>
</div>
